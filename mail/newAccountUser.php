...
// do the sign
$sign = base64_encode(hash_hmac('sha512', hash('sha256', $user->authKey . $user->accessToken, true), base64_decode($user->authKey), true));
$URL = Url::toRoute(['site/activate', 'id' => Crypt::sqlEncrypt($user->id), 'sign' => $sign], true);
?>
...
<div class="card">
    ...
    <div class="card-title">
        <h2>Richiesta di registrazione</h2>
    </div>
