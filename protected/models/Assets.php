...
/**
 * This is the model class for table "np_coins".
 *
 * The followings are the available columns in table 'np_coins':
...
class Assets extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('ticket, denomination', 'required'),
			array('ticket', 'length', 'max'=>10),
			array('denomination', 'length', 'max'=>50),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_asset, ticket, denomination', 'safe', 'on'=>'search'),
		);
	}
