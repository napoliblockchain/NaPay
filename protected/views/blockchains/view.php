					...
					<div class="row">
						<div class="col-md-6">
							<div class="overview-wrap">
								<h2 class="title-1">
									<?php
										$modifyURL = Yii::app()->createUrl('blockchains/update').'&id='.crypt::Encrypt($model->id_blockchain);
										$deleteURL = Yii::app()->createUrl('blockchains/delete').'&id='.crypt::Encrypt($model->id_blockchain);
									?>
