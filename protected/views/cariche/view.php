					...
					<div class="table-responsive table--no-card">
						<?php $this->widget('zii.widgets.CDetailView', array(
							...
							'attributes'=>array(
								...
								array(
						            'label'=>'Ruolo',
						            'value'=>UsersType::model()->findByPk($model->id_users_type)->desc
						        ),
							),
						));
						?>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="overview-wrap">
								<h2 class="title-1">
									<?php
										$modifyURL = Yii::app()->createUrl('cariche/update').'&id='.crypt::Encrypt($model->id_carica);
										$deleteURL = Yii::app()->createUrl('cariche/delete').'&id='.crypt::Encrypt($model->id_carica);
									?>
