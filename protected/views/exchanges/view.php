					...
					<div class="row">
						<div class="col-md-6">
							<div class="overview-wrap">
								<h2 class="title-1">
									<?php
										$modifyURL = Yii::app()->createUrl('exchanges/update').'&id='.crypt::Encrypt($model->id_exchange);
										$deleteURL = Yii::app()->createUrl('exchanges/delete').'&id='.crypt::Encrypt($model->id_exchange);
									?>
