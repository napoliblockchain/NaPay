		...
		<div class="container-fluid">
			...
			?>
				...
				<li class="has-sub" style='display: <?php echo $visible[20]; ?>;'>
					...
					<ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
						<li>
							<a href="<?php echo Yii::app()->createUrl('institutes/index');?>">Istituti <i class="fa fa-picture-o"></i></a>
						</li>
						<li>
							<a href="<?php echo Yii::app()->createUrl('blockchains/index');?>">Blockchains <i class="fas fa-rocket"></i></a>
						</li>
						<li>
							<a href="<?php echo Yii::app()->createUrl('assets/index');?>">Assets <i class="fas fa-usd"></i></a>
						</li>
						<li>
