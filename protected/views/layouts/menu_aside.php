			...
			<?php
				...
				<ul class="list-unstyled navbar__list">
					...
					<li class="has-sub" style='display: <?php echo $visible[20]; ?>;'>
						...
						<ul class="list-unstyled navbar__sub-list js-sub-list">
							<li>
								<a href="<?php echo Yii::app()->createUrl('institutes/index');?>"><i class="fa fa-picture-o"></i>Istituti</a>
							</li>
							<li>
								<a href="<?php echo Yii::app()->createUrl('blockchains/index');?>"><i class="fas fa-rocket"></i>Server blockchains</a>
							</li>
							<li>
								<a href="<?php echo Yii::app()->createUrl('assets/index');?>"><i class="fas fa-usd"></i>Assets</a>
							</li>
							<li>
