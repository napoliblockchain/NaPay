...
<!-- HEADER -->
  ...
  <tr>
		<td style="min-width: 590px;" align="center">
                ...
                <div>
									<p style="margin-top: 10px;font-size: 14px;">la tua iscrizione a <strong><?php echo Yii::app()->params['nomeAssociazione']; ?></strong> è stata accettata!</p>
								</div>
									<p style="margin-top: 10px;font-size: 14px;">
										Ora non ti resta che effettuare il pagamento della quota di iscrizione per attivare il tuo account.<br>
					        Puoi effettuare il pagamento in Bitcoin e Paypal tramite procedura online, oppure in contanti tramite un nostro associato.
									</p>
								<div>
								</div>

								<div>
									<p style="margin-top: 10px;font-size: 14px;">Clicca sul pulsante seguente per pagare online.</p>
								</div>
								<div>
												<a href="<?php echo $URL;?>">
														<button type="button" style="padding: 3px 3px 3px 3px;
															...
															min-width: 100px;
															min-height: 30px;
															text-shadow: 1px 1px 2px black;"> Login </button>
												</a>
