					...
					<tbody>
						<tr>
							<td style="font-family:Roboto,Tahoma,Verdana,Segoe,sans-serif; color: #555; font-size: 14px;" valign="top">
                				...
                				<div>
									<p style="margin-top: 10px;font-size: 14px;">ti informiamo che la modifica al consenso del trattamento dei dati per finalità di marketing da parte di <strong><?php echo Yii::app()->params['nomeAssociazione']; ?></strong>										è andata a buon fine.
									</p>
								</div>
