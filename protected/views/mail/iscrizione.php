					...
					<tbody>
						<tr>
							<td style="font-family:Roboto,Tahoma,Verdana,Segoe,sans-serif; color: #555; font-size: 14px;" valign="top">
								<div>
									<p style="font-size:34px;color:rgb(57,150,220)">Iscrizione</p>
								</div>
								<div>
									<p style="margin-top: 10px;font-size: 14px;">Ciao <strong><?php echo $name; ?></strong>,</p>
								</div>
								<div>
									<p style="margin-top: 10px;font-size: 14px;">La tua iscrizione a <strong><?php echo Yii::app()->params['nomeAssociazione']; ?></strong> è stata inoltrata!</p>
								</div>
								<div>
									<p style="font-size: 14px;">Ti invieremo una mail con la conferma della registrazione non appena sarà approvata.
										<br>Successivamente, riceverai le istruzioni per effettuare il pagamento della Quota Associativa necessaria per attivare il tuo account.
									</p>
								</div>
								<div>
									<h3 style="margin-top: 10px;">Riepilogo iscrizione</h3>
								</div>
								<div>
								...
								<div>
										<p style="font-size: 14px;"><strong><i>Per questioni di sicurezza si consiglia di modificare la password dopo il primo accesso.</i></strong>
										</p>
								</div>
