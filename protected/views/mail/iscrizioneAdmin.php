					...
					<tbody>
						<tr>
							<td style="font-family:Roboto,Tahoma,Verdana,Segoe,sans-serif; color: #555; font-size: 14px;" valign="top">
								<div>
									<p style="font-size:34px;color:rgb(57,150,220)">Nuova Iscrizione</p>
								</div>

								<div>
									<p style="font-size: 14px;">Un nuovo utente si è registrato.
									</p>
									<p>Collegati per approvare o negare l'iscrizione.<p>
								</div>
								<div>
