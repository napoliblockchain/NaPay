<?php
$URL = 'https://'.$_SERVER['HTTP_HOST'].Yii::app()->createUrl('site/regenerate').'&activation_code='.$activation_code;
?>
					...
					<tbody>
						<tr>
							<td style="font-family:Roboto,Tahoma,Verdana,Segoe,sans-serif; color: #555; font-size: 14px;" valign="top">
								<div>
									<p style="font-size:34px;color:rgb(57,150,220)">Ripristino password</p>
								</div>
								<div>
									<p style="margin-top: 10px;font-size: 14px;">Attenzione <strong><?php echo $name; ?></strong>!</p>
								</div>
								<div>
									<p style="margin-top: 10px;font-size: 14px;">Qualcuno ha chiesto di generare una nuova password!
				          <br>
				          Se sei stato tu, clicca sul pulsante seguente e segui le operazioni di ripristino.</p>
								</div>
								<div>
                        <a href="<?php echo $URL;?>">
                            <button type="button" style="padding: 3px 3px 3px 3px;
                              ...
                              cursor: pointer;
                    					...
                    					min-width: 100px;
															min-height: 30px;
                    					text-shadow: 1px 1px 2px black;">Recupera password</button>
                        </a>
