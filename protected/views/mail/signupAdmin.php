<?php
$URL = 'https://'.$_SERVER['HTTP_HOST'].Yii::app()->createUrl('site/activate').'&activation_code='.$activation_code;
?>
					...
					<tbody>
						<tr>
							<td style="font-family:Roboto,Tahoma,Verdana,Segoe,sans-serif; color: #555; font-size: 14px;" valign="top">
								<div>
									<p style="font-size:34px;color:rgb(57,150,220)"><?php echo Yii::t('lang','Account registration');?></p>
								</div>
								<div>
									<p style="margin-top: 28px;font-size: 14px;"><?php echo Yii::t('lang','Hi');?>, <strong><?php echo ($name <> 0 ? $name : $surname); ?></strong>!</p>
								</div>
								<div>
									<p style="margin-top: 28px;font-size: 14px;"><?php echo Yii::t('lang','Someone requested to register a new account.');?>
				          <br>
				          <b><?php echo Yii::t('lang','If you did not make this request please ignore this email and do NOT follow the link below');?></b>.</p>
								</div>
								<div>
                        <a href="<?php echo $URL;?>">
                            <button type="button" style="padding: 3px 3px 3px 3px;
                              ...
                              cursor: pointer;
                    					...
                    					min-width: 100px;
															min-height: 30px;
                    					text-shadow: 1px 1px 2px black;"><?php echo Yii::t('lang','Register');?></button>
                        </a>
