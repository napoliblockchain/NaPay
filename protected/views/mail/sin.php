<?php
$URL = 'https://pos.napoliblockchain.it/index.php?r=site/login&sin='.$password; 
?>
					...
					<tbody>
						<tr>
							<td style="font-family:Roboto,Tahoma,Verdana,Segoe,sans-serif; color: #555; font-size: 14px;" valign="top">
								<div>
									<p style="font-size:34px;color:rgb(57,150,220)">Creazione POS</p>
								</div>
								<div>
									<p style="margin-top: 10px;font-size: 14px;">Ciao <strong><?php echo $name; ?></strong>,</p>
								</div>
								<div>
									<p style="margin-top: 10px;font-size: 14px;">il tuo POS è stato creato!</p>
								</div>
								<div>
