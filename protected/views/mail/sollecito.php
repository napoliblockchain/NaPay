	  ...
	  <!-- CONTENT -->
  		<tr>
			<td style="min-width: 590px;" align="center">
                ...
                <div>
									<p style="margin-top: 10px;font-size: 14px;">ti informiamo che la tua iscrizione a
										<strong><?php echo Yii::app()->params['nomeAssociazione']; ?></strong>
										è <b><span style="color: red;"><?php echo strtolower(WebApp::StatoPagamenti($id_user,false,true)); ?>.</span></b>
									</p>
								</div>
									<p style="margin-top: 10px;font-size: 14px;">
										Per continuare a sostenere l'associazione e beneficiare dei servizi offerti è importante versare la quota associativa entro il 31 gennaio.
									</p>
									<p style="margin-top: 10px;font-size: 14px;">
										Se hai già provveduto al pagamento, ti prego di ignorare questo messaggio, altrimenti ti ricordo che puoi
										versare la quota in <b>Bitcoin</b> oppure in Euro attraverso Paypal o bonifico bancario.
									</p>
								...
								<div>
									<p style="margin-top: 10px;font-size: 14px;">Clicca sul pulsante seguente per rinnovare l'iscrizione.</p>
								</div>
								<div>
												<a href="<?php echo $URL;?>">
														<button type="button" style="padding: 3px 3px 3px 3px;
															...
															min-width: 100px;
															min-height: 30px;
															text-shadow: 1px 1px 2px black;"> Rinnova </button>
												</a>
								...
								<div>
									<p style="margin-top: 10px;font-size: 14px;">Grazie per averci scelto.</p>
								</div>
								<div>
