<?php
$URL = 'https://'.$_SERVER['HTTP_HOST'].Yii::app()->createUrl('site/login');
?>
					...
					<tbody>
						<tr>
							<td style="font-family:Roboto,Tahoma,Verdana,Segoe,sans-serif; color: #555; font-size: 14px;" valign="top">
								...
								<div>
									<p style="margin-top: 10px;font-size: 14px;">il pagamento per l'iscrizione a <b><?php echo Yii::app()->params['adminName']; ?></b> è andata a buon fine!
									<br>Puoi scaricare la ricevuta del pagamento effettuando il login all'applicazione.</p>
								</div>
								<div>
									<p style="margin-top: 10px;font-size: 14px;">Clicca sul pulsante seguente per collegarti.</p>
								</div>
								<div>
												<a href="<?php echo $URL;?>">
