					...
					<tbody>
						<tr>
							<td style="font-family:Roboto,Tahoma,Verdana,Segoe,sans-serif; color: #555; font-size: 14px;" valign="top">
								<div>
									<p style="font-size:34px;color:rgb(57,150,220)">Iscrizione negata</p>
								</div>
								<div>
									<p style="margin-top: 10px;font-size: 14px;">Ciao <strong><?php echo $name; ?></strong>,</p>
								</div>
                <div>
									<p style="margin-top: 10px;font-size: 14px;">la tua registrazione a <?php echo Yii::app()->params['nomeAssociazione']; ?> non è stata accettata!</p>
								</div>

								<div>
									<h3 style="margin-top: 10px;">Motivazioni</h3>
								</div>
								<div>
