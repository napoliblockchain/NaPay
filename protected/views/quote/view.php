					...
					<div class="table-responsive table--no-card ">
						<?php $this->widget('zii.widgets.CDetailView', array(
							...
							'attributes'=>array(
								...
								array(
						            'label'=>'Scadenza',
									'value'=>$scadenza[$model->extension],
						        ),
								'importo',
							),
						));
					...
					<div class="row">
						<div class="col-md-6">
							<div class="overview-wrap">
								<h2 class="title-1">
									<?php
										$modifyURL = Yii::app()->createUrl('quote/update').'&id='.crypt::Encrypt($model->id_quota);
										$deleteURL = Yii::app()->createUrl('quote/delete').'&id='.crypt::Encrypt($model->id_quota);
									?>
