					...
					<div class="row">
						<div class="col-md-6">
							<div class="overview-wrap">
								<h2 class="title-1">
									<?php
										$modifyURL = Yii::app()->createUrl('tipoPagamenti/update').'&id='.crypt::Encrypt($model->id_tipo_pagamento);
										$deleteURL = Yii::app()->createUrl('tipoPagamenti/delete').'&id='.crypt::Encrypt($model->id_tipo_pagamento);
									?>
